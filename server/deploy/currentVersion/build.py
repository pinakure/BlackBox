...
class Build:
    ...
    def deploy_title(self, title):
        ...
        target = title['url'].split('.')[0]
        os.system(f'{self.erase} {self.code_path}/data/{target}.zip 1>NUL 2>NUL')
        os.system(f'{self.erase} {self.code_path}/data/scripts/* /q 1> NUL 2> NUL')
        os.system(f'{self.erase} {self.code_path}/data/scripts/__pycache__/* /q 1> NUL 2>NUL')
        os.system(f'{self.erasedir} {self.code_path}/data/scripts/__pycache__/ 1> NUL 2> NUL')
        os.system(f'{self.erasedir} {self.code_path}/data/scripts/ 1> NUL 2> NUL')
