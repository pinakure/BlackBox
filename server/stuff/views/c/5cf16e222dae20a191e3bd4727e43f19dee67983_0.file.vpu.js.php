<?php /* Smarty version 3.1.24, created on 2021-02-26 00:01:36
         compiled from "C:/codigo/BlackBox/server/stuff/include/vpu.js" */ ?>
<?php
/*%%SmartyHeaderCode:177096053660383a60335cf2_67062079%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5cf16e222dae20a191e3bd4727e43f19dee67983' => 
    array (
      0 => 'C:/codigo/BlackBox/server/stuff/include/vpu.js',
      1 => 1452809034,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '177096053660383a60335cf2_67062079',
  'variables' => 
  array (
    'width' => 0,
    'tile_width' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_60383a604f2983_85618191',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_60383a604f2983_85618191')) {
function content_60383a604f2983_85618191 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '177096053660383a60335cf2_67062079';
?>
/*--------------------------------------------------------------------------------------------------------------------------------
...
function Vpu(){
	...
	this.mapsize = ((<?php echo $_smarty_tpl->tpl_vars['width']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['tile_width']->value;?>
...
/<?php echo $_smarty_tpl->tpl_vars['tile_height']->value;?>
	...
	// Screen buffer
	this.map = new Videodata(<?php echo $_smarty_tpl->tpl_vars['width']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['tile_width']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['height']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['tile_height']->value;?>
,3);
	...
	this.cursorX = 0;
	this.cursorY = 0;
	this.cursorP = 0; //(cursorY * <?php echo $_smarty_tpl->tpl_vars['width']->value*$_smarty_tpl->tpl_vars['tile_width']->value;?>
) + cursorX;
	this.color = 0;
	this.paused = true;
	this.width = <?php echo $_smarty_tpl->tpl_vars['width']->value/$_smarty_tpl->tpl_vars['tile_width']->value;?>
;
	this.height = <?php echo $_smarty_tpl->tpl_vars['height']->value/$_smarty_tpl->tpl_vars['tile_height']->value;?>
;
	this.console = 0;
	this.system = 0;
	
	
	<?php if ($_smarty_tpl->tpl_vars['fire_enable']->value) {?>
...
Vpu.prototype.clean = function(){
	...
	//this.ctx.drawImage(vpu.data0,0, 0,<?php echo $_smarty_tpl->tpl_vars['tile_width']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['tile_height']->value;?>
,0,0,<?php echo $_smarty_tpl->tpl_vars['width']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['height']->value;?>
);
}
...
Vpu.prototype.resume = function(){
	if(!this.paused)return;
	this.paused = false;
	setInterval(redraw, 1000/<?php echo $_smarty_tpl->tpl_vars['fps']->value;?>
);
};
...
Vpu.prototype.getR = function(data,x, y){ return data[( ((y*<?php echo $_smarty_tpl->tpl_vars['width']->value;?>
)+x) <<2)]; }
Vpu.prototype.getG = function(data,x, y){ return data[( ((y*<?php echo $_smarty_tpl->tpl_vars['width']->value;?>
)+x) <<2)+1]; }
Vpu.prototype.getB = function(data,x, y){ return data[( ((y*<?php echo $_smarty_tpl->tpl_vars['width']->value;?>
)+x) <<2)+2]; }
Vpu.prototype.getA = function(data,x, y){ return data[( ((y*<?php echo $_smarty_tpl->tpl_vars['width']->value;?>
)+x) <<2)+3]; }
...
Vpu.prototype.postProcessor_fire = function(){
	...
	var r,g,b;
	var px,py;
	var d = this.ctx.getImageData(0, 0, <?php echo $_smarty_tpl->tpl_vars['width']->value;?>
, <?php echo $_smarty_tpl->tpl_vars['height']->value;?>
);
	var data = d.data;

	for(py=0;py < <?php echo $_smarty_tpl->tpl_vars['height']->value;?>
; py++){
		for(px=0; px < <?php echo $_smarty_tpl->tpl_vars['width']->value;?>
; px++){
			var rand = parseInt(Math.random()*1024);
			if(rand%2==0){
				if(this.variator==0)data[(pix)+0] = (this.getR(data,px, py) + (Math.random()*16) + this.getR(data,px, py+1) + this.getR(data,px+1, py))*<?php echo $_smarty_tpl->tpl_vars['fire_coefficient']->value;?>
;
				if(this.variator==1)data[(pix)+1] = (this.getG(data,px, py) + (Math.random()*16) + this.getG(data,px, py+1) + this.getG(data,px+1, py))*<?php echo $_smarty_tpl->tpl_vars['fire_coefficient']->value;?>
;
				if(this.variator==2)data[(pix)+2] = (this.getB(data,px, py) + (Math.random()*16) + this.getB(data,px, py+1) + this.getB(data,px+1, py))*<?php echo $_smarty_tpl->tpl_vars['fire_coefficient']->value;?>
;
			} else {
				if(this.variator==0)data[(pix)+0] = (this.getR(data,px, py) + (Math.random()*16) + this.getR(data,px, py+1) + this.getR(data,px-1, py))*<?php echo $_smarty_tpl->tpl_vars['fire_coefficient']->value;?>
;
...
function redraw() {	
	...
	for(;py < <?php echo $_smarty_tpl->tpl_vars['height']->value;?>
; py+=<?php echo $_smarty_tpl->tpl_vars['tile_height']->value;?>
){
		for(px=0; px < <?php echo $_smarty_tpl->tpl_vars['width']->value;?>
; px+=<?php echo $_smarty_tpl->tpl_vars['tile_width']->value;?>
){
			...
			<?php if ($_smarty_tpl->tpl_vars['fire_enable']->value) {?>if((tx[0] >0)&&(ty[0]>0))<?php }?>(vpu.ctx).drawImage(vpu.data0,tx[0]<<3, ty[0]<<3,<?php echo $_smarty_tpl->tpl_vars['tile_width']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['tile_height']->value;?>
,px,py,<?php echo $_smarty_tpl->tpl_vars['tile_width']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['tile_height']->value;?>
);
			(vpu.ctx).drawImage(vpu.data1[vpu.map.pals[1][position]],tx[1]<<3, ty[1]<<3,<?php echo $_smarty_tpl->tpl_vars['tile_width']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['tile_height']->value;?>
,px,py,<?php echo $_smarty_tpl->tpl_vars['tile_width']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['tile_height']->value;?>
);
			(vpu.ctx).drawImage(vpu.data2[vpu.map.pals[2][position]],tx[2]<<3, ty[2]<<3,<?php echo $_smarty_tpl->tpl_vars['tile_width']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['tile_height']->value;?>
,px,py,<?php echo $_smarty_tpl->tpl_vars['tile_width']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['tile_height']->value;?>
);
...
Vpu.prototype.locateCursor = function(x, y){
	this.cursorX = x;
	this.cursorY = y;
	this.cursorP = (this.cursorY << <?php echo $_smarty_tpl->tpl_vars['tile_width_factor']->value+1;?>
) + this.cursorX;
}
...
Vpu.prototype.putChar = function(index, color){
	...
	switch(index){
		...
		case 256+"\n".charCodeAt(0):
			this.cursorX=0;
			this.cursorY++;
			while(this.cursorY >= <?php echo $_smarty_tpl->tpl_vars['height']->value/($_smarty_tpl->tpl_vars['tile_height']->value);?>
) {
	...
	this.cursorP = (this.cursorY * <?php echo $_smarty_tpl->tpl_vars['width']->value/($_smarty_tpl->tpl_vars['tile_width']->value/2);?>
) + this.cursorX;		
	...
	if(this.cursorX == <?php echo $_smarty_tpl->tpl_vars['width']->value/($_smarty_tpl->tpl_vars['tile_width']->value/2);?>
 ) {
		this.cursorX = 0;
		this.cursorY++;
	}
