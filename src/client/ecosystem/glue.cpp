...
static PyModuleDef GenericGameModule= {PyModuleDef_HEAD_INIT, "gglib"		, NULL, -1, GenericGame::methods	, NULL, NULL, NULL, NULL};
...
static PyObject* PyInit_genericgame	(void){ return PyModule_Create(&GenericGameModule	);}
